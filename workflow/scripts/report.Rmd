...
if (file.exists(snakemake@params[["cumulative_plot"]])) {
  cat("![](", snakemake@params[["cumulative_plot"]], ")")
}

if (file.exists(snakemake@params[["Nx_plot"]])) {
  cat("![](", snakemake@params[["Nx_plot"]], ")")
}
